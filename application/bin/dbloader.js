...
async function getConnection() {
  return await mysql.createConnection({
    host: "localhost",
    // make sure to change to the user you want to use
    user: "root", //Your DB username
    // make sure to change to the correct password for your user.
    password: "zuby123", //Your DB password
  });
}

async function makeDatabase(connection) {
  // make sure to change yourdbnamehere
